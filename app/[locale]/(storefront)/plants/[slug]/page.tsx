      ...
      <div className="container-page pt-8 md:pt-12">
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            {/* The botanical name keeps its italic. Here it is a convention
                rather than a flourish — a species name is italicised wherever
                it is printed, and a shopper who knows that reads it faster. */}
            <p className="mt-2 text-lg italic text-text-tertiary">
